...
- ✅ Story 03: AI-Enhanced Solution Generation (COMPLETED)
- 🎯 Story 04: OpenSearch Vector Integration (PRIMARY FOCUS)
...
```
Question Generation → Embedding Generation → OpenSearch Storage →
Semantic Search → Duplicate Detection → Similar Questions API →
...
- Test end-to-end question → embedding → index flow
...
- **DEC-001**: Embedding Model Selection → Ollama nomic-embed-text
- **DEC-002**: OpenSearch Deployment → Docker container for MVP
- **DEC-003**: Duplicate Detection Timing → Post-generation check
- **DEC-004**: Similarity Threshold → 0.90 (90%) per AC-003
...
- ✅ Docker-based services work well - apply to OpenSearch
- ✅ Modular service architecture - create OpenSearchModule
- ✅ Comprehensive testing crucial - plan test strategy early
- ✅ Performance monitoring from start - build in metrics
...
### Step 2: Create Vector Index with knn_vector Mapping [✅ COMPLETE]
...
#### Files Modified
- ✅ `api/src/app/opensearch/vector-index.service.ts` (270 lines)
- ✅ `api/src/app/opensearch/vector-index.service.spec.ts` (14 test cases)
- ✅ `api/src/app/opensearch/opensearch.module.ts` (added VectorIndexService)
...
- ✅ Index mapping validation (dimensions, algorithm, similarity)
- ✅ Index creation (new + idempotent)
...
- ✅ All vector index operations tested
- ✅ Error scenarios validated
- ✅ Integration with OpenSearchService verified

#### Next Step
Step 3: Implement EmbeddingService with Ollama nomic-embed-text model for 384-dimensional embeddings


### Step 3: Implement Embedding Generation Service [✅ COMPLETE]
...
#### Files Modified
- ✅ `api/src/app/opensearch/embedding.service.ts` (180 lines)
- ✅ `api/src/app/opensearch/embedding.service.spec.ts` (15 test cases)
- ✅ `api/src/app/opensearch/opensearch.module.ts` (added EmbeddingService, HttpModule)
...
- ✅ Empty text handling
- ✅ Ollama server unreachable error handling
- ✅ Missing embedding response validation
- ✅ Dimension validation (rejects non-384 embeddings)
- ✅ Batch embedding generation (multiple texts)
- ✅ Empty array batch handling
- ✅ Partial failure handling in batch operations
- ✅ Cache functionality (hit/miss scenarios)
- ✅ Cache for identical text
- ✅ No cache for different texts
- ✅ Cache clearing functionality
- ✅ Cache statistics retrieval
- ✅ Model configuration validation
- ✅ nomic-embed-text model usage
...
#### Coverage Validation
- ✅ Test coverage maintained above 80%
- ✅ All embedding generation paths tested
- ✅ Cache behavior validated
- ✅ Error scenarios comprehensive
- ✅ Integration with OpenSearchModule verified
...
### Step 4: Integrate Embeddings with Question Generation [✅ COMPLETE]
...
#### Files Modified
- ✅ `api/src/app/opensearch/question-indexing.service.ts` (235 lines)
- ✅ `api/src/app/opensearch/question-indexing.service.spec.ts` (12 test cases)
- ✅ `api/src/app/opensearch/opensearch.module.ts` (added QuestionIndexingService)
...
- ✅ Single question embedding + indexing flow
- ✅ Embedding generation failure handling
- ✅ Indexing failure handling
- ✅ Grade extraction from difficulty level
- ✅ Batch question embedding + indexing
- ✅ Empty array batch handling
- ✅ Batch embedding failure handling
- ✅ Difficulty score calculation
- ✅ Subtraction question metadata
...
2. **Metadata Mapping**: Grade extracted from enum (grade_3 → 3), difficulty score normalized (0.3 for GRADE_3)
...
#### Coverage Validation
- ✅ Test coverage maintained above 80%
- ✅ All indexing paths tested
- ✅ Error scenarios validated
- ✅ Metadata extraction verified
- ✅ Integration with EmbeddingService + VectorIndexService confirmed

#### Integration Flow
```
MathQuestion → QuestionIndexingService → EmbeddingService → 384-dim embedding
                                      → VectorIndexService → OpenSearch index
```
